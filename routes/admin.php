...
Route::group(['middleware' => ['check:1']], function () {
    ...
    Route::delete('/admins/{admin}','AdminsController@destroy')->name('admins_destroy');
    ...
    Route::patch('/admins/{admin}','AdminsController@update')->name('admins_update');
});
...
Route::group(['middleware' => ['check:3']], function () {
	...
	Route::get('/managers/show/{manager}','ManagersController@show')->name('managers_show');
	Route::get('/managers/edit/{manager}','ManagersController@edit')->name('managers_edit');
