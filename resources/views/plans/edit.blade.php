			...
			<template slot = "body">
	            <div class="content">
	                ...
	                <bootstrap-input class="form-group-no-border {{ $errors->has('name') ? ' has-danger' : '' }}" 
	                    ...
	                    b-name="name"
	                    b-type="text"
	                    b-value="{{ old('name') ? old('name') : $plan->name }}"
	                ...
	                <bootstrap-textarea class="form-group-no-border {{ $errors->has('desc') ? ' has-danger' : '' }}" 
	                    ...
	                    b-name="desc"
	                    b-type="text"
	                    b-value="{{ old('desc') ? old('desc') : $plan->desc }}"
	                ...
	                <bootstrap-select class="form-group-no-border {{ $errors->has('pre') ? ' has-danger' : '' }}"
	                    ...
	                    <template slot="select">
	                    	<div class="input-group">
	                    		{{ Form::text('pre',old('pre') ? old('pre') : $plan->pre,['id'=>'pre','class'=>'form-control','readonly'=>'true','style'=>'background-color:#ffffff;']) }}
	                ...
	                <bootstrap-select class="form-group-no-border {{ $errors->has('price') ? ' has-danger' : '' }}"
	                    ...
	                    <template slot="select">
	                    	<div class="input-group">
	                    		{{ Form::text('price',old('price') ? old('price') : $plan->price,['id'=>'price','class'=>'form-control','readonly'=>'true','style'=>'background-color:#ffffff;']) }}
	                    		<span class="input-group-btn">
	                ...
	                <bootstrap-select class="form-group-no-border {{ $errors->has('post') ? ' has-danger' : '' }}"
	                    ...
	                    <template slot="select">
	                    	<div class="input-group">
	                    		{{ Form::text('post',old('post') ? old('post') : $plan->post,['id'=>'post','class'=>'form-control','readonly'=>'true','style'=>'background-color:#ffffff;']) }}
	                    		<span class="input-group-btn">
	                ...
	                <bootstrap-select class="form-group-no-border {{ $errors->has('cancel') ? ' has-danger' : '' }}"
	                    ...
	                    <template slot="select">
	                    	<div class="input-group">
	                    		{{ Form::text('cancel',old('cancel') ? old('cancel') : $plan->cancel,['id'=>'cancel','class'=>'form-control','readonly'=>'true','style'=>'background-color:#ffffff;']) }}
	                    		<span class="input-group-btn">
	                ...
	                >
	                	<template slot="select">
	                		{{ Form::select('hourly',[0=>'No',1=>'Yes'],old('hourly') ? old('hourly') : $plan->hourly,['class'=>'custom-select']) }}
	                	</template>
	                ...
	                >
	                	<template slot="select">
	                		{{ Form::select('daily',[0=>'No',1=>'Yes'],old('daily') ? old('daily') : $plan->daily,['class'=>'custom-select']) }}
	                	</template>
	                ...
	                >
	                	<template slot="select">
	                		{{ Form::select('weekly',[0=>'No',1=>'Yes'],old('weekly') ? old('weekly') : $plan->weekly,['class'=>'custom-select']) }}
	                	</template>
	                ...
	                >
	                	<template slot="select">
	                		{{ Form::select('monthly',[0=>'No',1=>'Yes'],old('monthly') ? old('monthly') : $plan->monthly,['class'=>'custom-select']) }}
	                	</template>
	                ...
	                >
	                	<template slot="select">
	                		{{ Form::select('yearly',[0=>'No',1=>'Yes'],old('yearly') ? old('yearly') : $plan->yearly,['class'=>'custom-select']) }}
	                	</template>
